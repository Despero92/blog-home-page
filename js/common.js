$(document).ready(function() {
    ...
    $("#owl-carousel .owl-prev").empty().append("<i class=\"fa fa-angle-left fa-4x\" aria-hidden=\"true\"></i>");
    $("#owl-carousel .owl-next").empty().append("<i class=\"fa fa-angle-right fa-4x\" aria-hidden=\"true\"></i>");
